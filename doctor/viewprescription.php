...
$prescriptionDetails = getThis("SELECT `doctorID`,  `symptoms`, `dietAdvice`, `specialAdvice`, `doctorFindings`, `doctorDiagnosis`, `labTestAdvice`, `medicinePrescribed`, `medicineDosage`, `medicineInstructions`, `generatedAt` FROM `prescription` WHERE `id` = '$prescriptionID'");
...
<div class="app-main__outer">
    <div class="app-main__inner">
        <div class="card-body">
            <h5 class="card-title">Prescritpion Details</h5>
            <table class="mb-0 table table-striped">
                ...
                <tr>
                    <td>Findings</td>
                    <td><?php
                        $temp = e_d('d', $prescriptionDetails['doctorFindings']);
                        $temp = unserialize($temp);
                ...
                <tr>
                    <td>Diagnosis</td>
                    <td><?php
                        $temp = e_d('d', $prescriptionDetails['doctorDiagnosis']);
                        $temp = unserialize($temp);
                ...
                <tr>
                    <td>Lab Tests</td>
                    <td><?php
                        $temp = e_d('d', $prescriptionDetails['labTestAdvice']);
                        $temp = unserialize($temp);
